...
public class RestAssuredGetAllureTest {
    ...
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NDdjNzUxMDQzNDI0NDAwM2QyNzc1ZmYiLCJpYXQiOjE2OTI3ODEwMDAsImV4cCI6MTY5MzM4NTgwMH0.0ZERHJ0bgVLyPQLosLrnHEV68g-JVsEP4HtLHvV33dE";
    ...
    public void checkUserName() {
        given()
                .auth().oauth2(bearerToken)
                .get("/api/users/me")
                .then().assertThat().body("data.name",equalTo("chemshit_21@gmail.com"));
    }
    ...
    public void checkUserNameAndPrintResponseBody() {
        ...
        response.then().assertThat().body("data.name",equalTo("chemshit_21@gmail.com"));
